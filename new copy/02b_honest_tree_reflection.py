...
PREDICTORS = ["tses_is", "score1", "das_depression"]
# %%
df = pd.read_stata(
...
model = DecisionTreeRegressor(min_samples_leaf=5, random_state=SEED, max_depth=1)
...
testing["leaf"] = testing.predicted_growth.round(3).map({0.833: 1, 1.524: 2})
